...
const Destinations = () => {
  return (
    <div className="h-auto text-white p-10 md:p-20" id="destination">
      <p className="font-heading text-3xl md:text-4xl text-center mb-5">Popular Destinations</p>
      <p className="tracking-[.40em] text-white font-primary text-sm text-center md:text-center mb-3 md:mb-6">FEATURED LANDSCAPES</p>
      ...
      <div className="grid gap-5">
        ...
        >
          ...
          <div className="flex-auto text-white space-y-4 p-8 ">
            ...
            <p className="font-primary text-sm md:text-md bg-green-800/40 p-3 rounded-md w-fit shadow-inner shadow-green-600/50">LOCATION: CROSS RIVER STATE</p>
            <p className="font-primary text-md md:text-xl">Obudu Mountain Resort, also known as Obudu Cattle Ranch, is one of Nigeria’s most sought-after tourist destinations, 
              ...
              rolling hills.</p>
              <p className="font-primary text-sm md:text-md bg-amber-800/40 p-3 rounded-md w-fit shadow-inner shadow-amber-600/50">
              What to explore:<ul>
        ...
        >
          ...
          <div className="flex-auto text-white space-y-4 p-8 ">
            ...
            <p className="font-primary text-sm md:text-md bg-green-800/40 p-3 rounded-md w-fit shadow-inner shadow-green-600/50">LOCATION: ANAMBRA STATE</p>
        ...
        >
          ...
          <div className="flex-auto text-white space-y-4 p-8 ">
            ...
            <p className="font-primary text-sm md:text-md bg-green-800/40 p-3 rounded-md w-fit shadow-inner shadow-green-600/50">LOCATION: OGUN STATE</p>
        ...
        >
          ...
          <div className="flex-auto text-white space-y-4 p-8 ">
            ...
            <p className="font-primary text-sm md:text-md bg-green-800/40 p-3 rounded-md w-fit shadow-inner shadow-green-600/50">LOCATION: NIGER STATE</p>
