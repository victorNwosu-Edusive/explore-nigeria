...
function Navbar() {
    ...
    return (
        <>
        <ScrollToTop />
        <nav className='fixed z-50 w-full lg:w-full p-4 ease-in bg-emerald-900/70 backdrop-blur-md flex flex-wrap justify-between items-center mx-auto max-w-screen-3xl'>
